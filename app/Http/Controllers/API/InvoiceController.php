...
class InvoiceController extends BaseController
{
    ...
    {
        $invoices = Invoice::select('tblInvoiceMain.InvoiceID as MainID', 'tblInvoiceMain.user_id as userd', 'tblInvoiceMain.InvoiceCustID as CustID', 'tblInvoiceMain.InvoiceDate as Date', 'users.name as agentName', 'tblCustomer.CustName')
